...
import type { RoiCamera } from '../../../shared/roi';
import { orientedSize } from '../utils/roiGeometry';
...
canvas { position: absolute; width: 100%; height: 100%; object-fit: contain; inset: 0; }
